...
export const quickQuestions: QuickQuestion[] = [
  {
    ...
    emoji: "🚗",
    prompt: "I met with a road accident. I have pain and some bleeding — what should I do right now?",
  },
  { id: "chest", label: "Chest pain", emoji: "🫀", prompt: "I have severe chest pain spreading to my left arm and I feel sweaty." },
  { id: "fever", label: "High fever", emoji: "🌡️", prompt: "High fever of 103°F since last night with body aches and chills." },
  { id: "snake", label: "Snake bite", emoji: "🐍", prompt: "Someone was bitten by a snake on the leg a few minutes ago." },
  { id: "burn", label: "Burn", emoji: "🔥", prompt: "I burnt my hand with hot oil and blisters are forming." },
  { id: "child", label: "Child emergency", emoji: "🧒", prompt: "My 4 year old child is vomiting, very drowsy and refusing water." },
  { id: "breath", label: "Difficulty breathing", emoji: "🫁", prompt: "I am struggling to breathe and my chest feels tight." },
  { id: "medicine", label: "Medicine advice", emoji: "💊", prompt: "What general painkiller is usually safe for an adult with a headache, and what should I avoid?" },
  { id: "cpr", label: "CPR guidance", emoji: "🫱", prompt: "Someone has collapsed and is not breathing. Guide me through CPR step by step." },
  { id: "bp", label: "Blood pressure", emoji: "📈", prompt: "My blood pressure reading is 165/100 today. What should I do?" },
];
